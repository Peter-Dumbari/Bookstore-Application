...
```sh
  cd my-folder
  git clone (https://github.com/Peter-Dumbari/Bookstore-Application.git)
```
...
Feel free to check the [issues page](https://github.com/Peter-Dumbari/Bookstore-Application/issues).
